...
public class ReadingService extends Service {
    ...
    public void onCreate() {
        ...
        ttsPlayer = new TTSPlayer(this, new TTSPlayer.OnTTSListener() {
            ...
            public void onSentenceChanged(int index) {
                ...
                // Broadcast playing state to ensure UI remains in sync
    ...
    private void forward() {
        if (ttsPlayer != null) {
            ttsPlayer.setCurrentIndex(ttsPlayer.getCurrentIndex() + 1);
            startPlayback();
        }
    }
    ...
    private void rewind() {
        if (ttsPlayer != null) {
            ttsPlayer.setCurrentIndex(Math.max(0, ttsPlayer.getCurrentIndex() - 1));
            startPlayback();
        }
    }
    ...
    private void loadLastBookAsync(boolean forcePlay) {
        if (isLoading) {
            if (forcePlay) playAfterLoadRequested = true;
            return;
        }
        currentBookUri = settings.getLastOpenedBookUri();
        ...
        new Thread(() -> {
            try {
                ...
                if (meta != null && meta.sentences != null && !meta.sentences.isEmpty()) {
                    ...
                    if (forcePlay || playAfterLoadRequested) {
                        playAfterLoadRequested = false;
        ...
        if (intent != null) {
            ...
            if (ACTION_LOAD.equals(action)) {
                ...
                if (sentences != null && !sentences.isEmpty()) {
                    ...
                    currentBookUri = settings.getLastOpenedBookUri();
                    mediaSession.setMetadata(new MediaMetadataCompat.Builder()
                            .putString(MediaMetadataCompat.METADATA_KEY_TITLE, BookDataHolder.getInstance().getTitle())
                            .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, BookDataHolder.getInstance().getAuthor())
                            .build());
                } else {
                    loadLastBookAsync(false);
                }
            ...
            if (intent.hasExtra("INDEX")) ttsPlayer.setCurrentIndex(intent.getIntExtra("INDEX", 0));
    ...
    private Notification buildNotification() {
        ...
        PendingIntent pMain = PendingIntent.getActivity(this, 0, mainIntent, PendingIntent.FLAG_IMMUTABLE);
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setStyle(new androidx.media.app.NotificationCompat.MediaStyle()
                        ...
                        .setShowActionsInCompactView(1, 2, 3)) // Play, Forward, Close
                .addAction(android.R.drawable.ic_media_rew, "Rewind", 
                        PendingIntent.getService(this, 1, new Intent(this, ReadingService.class).setAction(ACTION_REWIND), piFlags))
                .addAction(isPlaying ? android.R.drawable.ic_media_pause : android.R.drawable.ic_media_play, 
                        isPlaying ? "Pause" : "Play", 
                        PendingIntent.getService(this, 2, new Intent(this, ReadingService.class).setAction(isPlaying ? ACTION_PAUSE : ACTION_PLAY), piFlags))
                .addAction(android.R.drawable.ic_media_ff, "Forward", 
                        PendingIntent.getService(this, 3, new Intent(this, ReadingService.class).setAction(ACTION_FORWARD), piFlags))
                .addAction(android.R.drawable.ic_menu_close_clear_cancel, "Close", 
                        PendingIntent.getService(this, 4, new Intent(this, ReadingService.class).setAction(ACTION_CLOSE), piFlags))
                .build();
    }
